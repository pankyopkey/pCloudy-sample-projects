...
namespace ConsoleApplication1
{
    class TestCase
    {
        ...
        PCloudyAppiumSession pCloudyDeviceSession = null;
        ...
        public void run() {
            try
            {
                ...
                try
                {
                    if (pCloudyDeviceSession != null)
                        pCloudyDeviceSession.releaseSessionNow();
                }
                catch (Exception e)
                {
                    log(e.Message);
        ...
        {
            Keywords keywords = new Keywords(this.pCloudyDeviceSession);
            try
            {
