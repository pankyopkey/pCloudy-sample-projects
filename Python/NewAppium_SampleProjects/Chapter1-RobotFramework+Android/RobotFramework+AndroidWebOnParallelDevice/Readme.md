...
Step-10: Run the script with the following cmd: ***pabot --argumentfile1 arg1.txt --argumentfile2 arg2.txt SampleTestCase.txt***
...
Go to arg1.txt and arg2.txt : Variable browserName can be change based on the name of the browser.
