...
exports.AllureInMemoryAllureWriter = void 0;
class AllureInMemoryAllureWriter {
    constructor() {
        this.groups = [];
        this.tests = [];
        this.attachments = {};
    ...
    writeAttachmentFromPath(from, toFileName) {
        throw new Error("Can't write attachment from path because generic writer doesn't implement this logic! Use AllureInMemoryWriter for node.js.");
    }
...
exports.AllureInMemoryAllureWriter = AllureInMemoryAllureWriter;
//# sourceMappingURL=AllureInMemoryWriter.js.map