...
const AllureCommandStep_js_1 = require("./AllureCommandStep.js");
const ExecutableItemWrapper_js_1 = require("./ExecutableItemWrapper.js");
const constructors_js_1 = require("./constructors.js");
const model_js_1 = require("./model.js");
const utils_js_1 = require("./utils.js");
class AllureTest extends ExecutableItemWrapper_js_1.ExecutableItemWrapper {
    constructor(runtime, start = Date.now()) {
        super((0, constructors_js_1.testResult)());
        this.runtime = runtime;
        this.historyIdSetManually = false;
        const globalLabels = (0, utils_js_1.getLabelsFromEnv)();
    ...
    addIssueLink(url, name) {
        this.addLink(url, name, model_js_1.LinkType.ISSUE);
    }
    addTmsLink(url, name) {
        this.addLink(url, name, model_js_1.LinkType.TMS);
    }
    calculateHistoryId() {
        ...
        const tcId = this.testResult.testCaseId
            ...
            : this.testResult.fullName
                ? (0, utils_js_1.md5)(this.testResult.fullName)
                : null;
        if (!tcId) {
            return;
        }
        const paramsString = this.testResult.parameters
            ...
            .join(",");
        const paramsHash = (0, utils_js_1.md5)(paramsString);
    ...
    applyMetadata(metadata, stepApplyFn) {
        ...
        steps.forEach((stepMetadata) => {
            const step = AllureCommandStep_js_1.AllureCommandStepExecutable.toExecutableItem(this.runtime, stepMetadata);
            if (stepApplyFn) {
                stepApplyFn(step);
                return;
            }
