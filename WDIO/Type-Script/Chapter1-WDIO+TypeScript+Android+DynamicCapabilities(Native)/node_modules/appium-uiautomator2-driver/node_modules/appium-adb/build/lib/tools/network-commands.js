...
async function getForwardList() {
    logger_js_1.log.debug(`List forwarding ports`);
...
async function removePortForward(systemPort) {
    logger_js_1.log.debug(`Removing forwarded port socket connection: ${systemPort} `);
...
async function getReverseList() {
    logger_js_1.log.debug(`List reverse forwarding ports`);
...
async function removePortReverse(devicePort) {
    logger_js_1.log.debug(`Removing reverse forwarded port socket connection: ${devicePort} `);
