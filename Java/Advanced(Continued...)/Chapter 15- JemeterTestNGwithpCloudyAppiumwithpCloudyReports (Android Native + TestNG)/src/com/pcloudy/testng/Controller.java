...
public class Controller {
	...
	public static String perlFilePath;
	...
	public static void main(String args[]) throws Exception {
		...
		perlFilePath = args[0];
		runExecutionOnPCloudy.runTestNGTest(perlFilePath);
		
		System.exit(0);
	}

	public void runTestNGTest(String perlFilePath) throws Exception {
		...
		for (int i = 0; i < bookedDevices.length; i++) {
			...
			report.HyperLinks.addLink("Performance Report",new File(System.getProperty("user.dir")+File.separator+"Reports"+File.separator+uniqueName+File.separator+"index.html").toURI().toURL());
			...
			aDeviceContext.con = con;
			aDeviceContext.token = authToken;
			aDeviceContext.perlFilePath = perlFilePath;
